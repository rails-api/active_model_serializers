...
ArraySerializer supports also +Special Association Serializers+.
...
In other words, if a ArraySerializer is trying to serialize comments, it will first
look for ArraySerializer::CommentSerializer before falling back to CommentSerializer
and finally comment.as_json.
