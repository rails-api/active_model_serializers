...
module ActiveModelSerializers
 ...
 override CollectionSerializer#paginated? to return 'false'.
        ...
        def next_page_url
          if ActiveModelSerializers.config.jsonapi_omit_total_pages
            next_page_url_without_total_pages
          else
            next_page_url_with_total_pages
          end
        end

        # avoid the 'COUNT(*)' query generated by `collection.total_pages`
        def next_page_url_without_total_pages
          return nil if collection.size < per_page
          url_for_page(collection.current_page + 1)
        end

        def next_page_url_with_total_pages
