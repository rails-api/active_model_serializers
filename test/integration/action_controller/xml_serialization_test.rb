  ...
  module XmlSerialization
    ...
    class ArrayEmbedingSerializerTest < ActionController::TestCase
      ...
      def test_render_xml_array_embeding_in_root
        ...
        assert_equal 'application/xml', @response.content_type
        assert_match format_xml("<hash><my type=\"array\"><my><name>Name 1</name><email>mail@server.com</email><profile-id type=\"integer\">#{@controller.user.profile.object_id}</profile-id></my></my><profiles type=\"array\"><profile><name>N1</name><description>D1</description></profile></profiles></hash>"), @response.body
      end
